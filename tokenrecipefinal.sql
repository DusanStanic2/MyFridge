...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2024 at 08:14 PM
...
(15, 1, 13, 'test', 3, 3, '2024-07-03 09:59:32', 'rrra');
...
(3, 2, 3, 'Spaghetti Carbonara', 'Classic Italian pasta dish.', 'carbonara.jpg', 8.00, 1, '2024-06-28 10:54:47', NULL),
(4, 2, 4, 'Chocolate Cake', 'Rich chocolate cake for dessert.', 'chocolate_cake.jpg', 10.00, 1, '2024-06-28 10:54:47', 'eeeeeee'),
(5, 3, 5, 'Fruit Smoothie', 'Refreshing smoothie with mixed fruits.', 'smoothie.jpg', 4.00, 1, '2024-06-28 10:54:47', NULL),
(13, 13, 5, 'reject', 'reject', 'Screenshot 2024-07-03 001350.png', 44.00, -1, '2024-07-03 09:53:47', 'final');
...
INSERT INTO `users` (`id`, `email`, `password`, `first_name`, `last_name`, `phone`, `role`, `is_active`, `created_at`, `reset_token`, `is_verified`, `registration_token`) VALUES
(1, 'admin@example.com', '$2y$10$7C1ZpY9.fh3.LKwKYeWbNeKyCj3W4wcf5BOLpk/fIPuxTukUhsyD.', 'Admin', 'User', NULL, 'admin', 0, '2024-06-28 10:54:47', NULL, 0, NULL),
(2, 'user1@example.com', '$2y$10$7C1ZpY9.fh3.LKwKYeWbNeKyCj3W4wcf5BOLpk/fIPuxTukUhsyD.', 'User', 'One', NULL, 'user', 0, '2024-06-28 10:54:47', NULL, 0, NULL),
(3, 'user2@example.com', '$2y$10$7C1ZpY9.fh3.LKwKYeWbNeKyCj3W4wcf5BOLpk/fIPuxTukUhsyD.', 'User', 'Two', NULL, 'user', 0, '2024-06-28 10:54:47', NULL, 0, NULL),
(4, 'dusanstanic2@gmail.com', '$2y$10$qoKblmF9sWEOgrD/jqQo3.ATIusXBr250nNhcvCdyYYqQPWHtHByy', 'Dušan', 'Stanić', '0601561826', 'user', 0, '2024-06-28 10:55:38', NULL, 0, NULL),
(5, 'jovicmilan047@gmail.com', '$2y$10$pXgPMC6VKClQ4TePIh91NeDcPAItLdmftXpPvHE.1vYvqXmjJzxB6', 'Dušan', 'Stanić', '0601561826', 'admin', 0, '2024-06-28 10:56:13', NULL, 1, NULL),
(7, 'dusanstanic200@gmail.com', '$2y$10$vW3RSvAeEK383cIZjt9JYe9f8cmjo0xFKwTg.hEvSB1vfdeqCnyaK', 'Dušan', 'Stanić', '0601561826', 'user', 1, '2024-06-28 11:15:37', NULL, 0, NULL),
(8, 'dusanstanic3@gmail.com', '$2y$10$94Yh8Ah.KoM0qArLS2FhCOf/qyCmzeothggz3268V.zjE2kcLp/PC', 'Dušan', 'Stanić', '0601561826', 'user', 0, '2024-06-30 13:15:50', NULL, 0, NULL),
(10, 'lukasudarevic03@gmail.com', '$2y$10$qi.VVP5uE9xfx0VjPa26ROum5DJPS9fn8dg3scvk03qd.btewHM6W', 'Luka', 'Sudarević', '0643020940', 'user', 0, '2024-07-02 17:08:35', NULL, 1, NULL),
(13, 'webprojekat4@gmail.com', '$2y$10$gTUWjX/jtYGamz.ZAtu1VulM4RdVr6AC.sRHAYqjM19dFn.2MHCO.', 'DušanEdit', 'Stanić', '0601561826', 'user', 0, '2024-07-03 09:48:10', NULL, 1, NULL);
